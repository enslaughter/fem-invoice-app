...
function AddInvoice(props: any) {
  ...
  const [editedInvoice, setEditedInvoice] = useState(deepClone(emptyInvoice));
  ...
  function updateInvoiceDueDate(iDate: any, iTerms: any) {
    ...
    let str = `${duedate.getFullYear()}-${duedate.getMonth() < 9 ? "0" : ""}${
      duedate.getMonth() + 1
    }-${duedate.getDate() < 9 ? "0" : ""}${duedate.getDate() + 1}`;
    setEditedInvoice((prevState: any) => {
  ...
  function handleCloseModal() {
    setEditedInvoice(deepClone(emptyInvoice));
    setFormErrors({});
  ...
  return (
    <div
      className="edit-invoice-container"
      style={
        props.editOpen
      ...
      <div
        ...
        style={
          props.editOpen
            ...
            : { transform: "translateX(-100%) translateX(-72px)" }
        }
      >
        <div style={{ padding: "24px" }}>
          <button
            className="invoice-goback"
          ...
          <p className="form-header">New Invoice</p>
        </div>

        <form
          style={
            windowSize.width > 0
              ? { maxHeight: `${windowSize.height - 346}px` }
              : {}
          }
        >
          ...
          <div className="form-flexbox">
            <div
              className={
                formErrors.senderstreet ? "form-label labelerror" : "form-label"
              }
            >
              <label htmlFor="sender-address">Street Address</label>
              {formErrors.senderstreet && (
                <p>
                  {formErrors.senderstreet === "empty"
                    ? "can't be empty"
                    : "invalid input"}
                </p>
              )}
            ...
            <input
              className={formErrors.senderstreet ? "formerror" : ""}
              type="text"
              name="street"
              id="sender-address"
              value={editedInvoice.senderAddress.street}
              onChange={handleFormChange_sender}
            ></input>
            ...
            <div className="form-flexbox--desktop-row">
              <div className="form-flexbox--row">
                <div>
                  ...
                  <input
                    className={formErrors.sendercity ? "formerror" : ""}
                    type="text"
                    name="city"
                    id="sender-city"
                ...
                <div>
                  ...
                  >
                    ...
                    {formErrors.senderpostCode && (
                      <p>
                        {formErrors.senderpostCode === "empty"
                          ? "can't be empty"
                          : "invalid input"}
                      </p>
                    )}
                  ...
                  <input
                    className={formErrors.senderpostCode ? "formerror" : ""}
                    type="text"
                    name="postCode"
                    id="sender-postcode"
              ...
              <div>
                ...
                >
                  ...
                  {formErrors.sendercountry && (
                    <p>
                      {formErrors.sendercountry === "empty"
                        ? "can't be empty"
                        : "invalid input"}
                    </p>
                  )}
                ...
                <input
                  className={formErrors.sendercountry ? "formerror" : ""}
                  type="text"
                  name="country"
                  id="sender-country"
          ...
          <div className="form-flexbox">
            <div
              className={
                formErrors.clientName ? "form-label labelerror" : "form-label"
              }
            >
              <label htmlFor="client-name">Client's Name</label>
              {formErrors.clientName && (
                <p>
                  {formErrors.clientName === "empty"
                    ? "can't be empty"
                    : "invalid input"}
                </p>
              )}
            ...
            <input
              className={formErrors.clientName ? "formerror" : ""}
              type="text"
              name="clientName"
              id="client-name"
            ...
            <div
              className={
                formErrors.clientEmail ? "form-label labelerror" : "form-label"
              }
            >
              <label htmlFor="client-email">Client's Email</label>
              {formErrors.clientEmail && (
                <p>
                  {formErrors.clientEmail === "empty"
                    ? "can't be empty"
                    : "invalid input"}
                </p>
              )}
            ...
            <input
              className={formErrors.clientEmail ? "formerror" : ""}
              type="text"
              name="clientEmail"
              id="client-email"
            ...
            <div
              className={
                formErrors.clientstreet ? "form-label labelerror" : "form-label"
              }
            >
              <label htmlFor="client-address">Street Address</label>
              {formErrors.clientstreet && (
                <p>
                  {formErrors.clientstreet === "empty"
                    ? "can't be empty"
                    : "invalid input"}
                </p>
              )}
            ...
            <input
              className={formErrors.clientstreet ? "formerror" : ""}
              type="text"
              name="street"
              id="client-address"
              value={editedInvoice.clientAddress.street}
              onChange={handleFormChange_client}
            ></input>
            ...
            <div className="form-flexbox--desktop-row">
              <div className="form-flexbox--row">
                <div>
                  ...
                  <input
                    className={formErrors.clientcity ? "formerror" : ""}
                    type="text"
                    name="city"
                    id="client-city"
                ...
                <div>
                  ...
                  >
                    ...
                    {formErrors.clientpostCode && (
                      <p>
                        {formErrors.clientpostCode === "empty"
                          ? "can't be empty"
                          : "invalid input"}
                      </p>
                    )}
                  ...
                  <input
                    className={formErrors.clientpostCode ? "formerror" : ""}
                    type="text"
                    name="postCode"
                    id="client-postcode"
              ...
              <div>
                ...
                >
                  ...
                  {formErrors.clientcountry && (
                    <p>
                      {formErrors.clientcountry === "empty"
                        ? "can't be empty"
                        : "invalid input"}
                    </p>
                  )}
                ...
                <input
                  className={formErrors.clientcountry ? "formerror" : ""}
                  type="text"
                  name="country"
                  id="client-country"
          ...
          <div className="form-flexbox">
            <div className="form-flexbox--desktop-datebox">
              <div>
                <div
                  className={
                ...
                <input
                  ...
                  name="createdAt"
                  id="invoice-duedate"
                  value={editedInvoice.createdAt}
                  onChange={handleFormChange}
                  disabled={editedInvoice.status !== "draft"}
                ></input>
              </div>
              <div>
                <div
                ...
                <select
                  className={formErrors.paymentTerms ? "formerror" : ""}
                  name="paymentTerms"
                  id="payment-terms"
            ...
            <div
              className={
                formErrors.description ? "form-label labelerror" : "form-label"
              }
            >
              <label htmlFor="project-description">Project Description</label>
              {formErrors.description && (
                <p>
                  {formErrors.description === "empty"
                    ? "can't be empty"
                    : "invalid input"}
                </p>
              )}
            ...
            <input
              className={formErrors.description ? "formerror" : ""}
              type="text"
              name="description"
          ...
          <div className="form-flexbox">
            {editedInvoice.items.map((item: any, key: any) => (
              <div key={key} style={{ width: "100%" }}>
                <div className="form-flexbox--desktop-items">
                  <div>
                    <div
                      className={
                        formErrors[`item${key}name`]
                          ? "form-label labelerror"
                          : "form-label"
                      }
                    >
                      <label
                        ...
                        htmlFor={`invoice-item-${item.name}`}
                      >
                        Item Name
                      </label>
                      {formErrors[`item${key}name`] && (
                        <p>
                          {formErrors[`item${key}name`] === "empty"
                            ? "can't be empty"
                            : "invalid input"}
                        </p>
                      )}
                    ...
                    <input
                      className={
                        formErrors[`item${key}name`] ? "formerror" : ""
                      }
                      type="text"
                      name="name"
                      id={`invoice-item-${item.name}`}
                      data-key={key}
                      value={item.name}
                      onChange={handleFormChange_items}
                    ></input>
                  </div>
                  <div className="form-flexbox--invoiceitems">
                    <div>
                      <label
                        htmlFor={`quantity-${key + 1}`}
                        style={
                          formErrors[`item${key}quantity`] && {
                            color: "hsl(0, 80%, 63%)",
                          }
                        }
                      >
                      ...
                      <input
                        className={
                          formErrors[`item${key}quantity`] ? "formerror" : ""
                        }
                        type="text"
                        name="quantity"
                        id={`quantity-${key + 1}`}
                    ...
                    <div>
                      ...
                      <input
                        className={
                          formErrors[`item${key}price`] ? "formerror" : ""
                        }
                        type="text"
                        name="price"
                        id={`price-${key + 1}`}
                        ...
                        size={7}
                        onChange={handleFormChange_items}
                        onBlur={handlePriceOut}
                      ></input>
                    </div>
                    <div>
                      <label htmlFor={`total-${key + 1}`}>Total</label>
                      <input
                        className="form-item-total"
                        type="text"
                        name="total"
                        id={`total-${key + 1}`}
                        data-key={key}
        ...
        <div style={{ position: "relative", backgroundColor: "transparent" }}>
          ...
          <div className="edit-modal-buttons">
            ...
            {editedInvoice.status === "draft" && (
              <button
                className="invoice-app--button button-savedraft"
            ...
            <button
              className="invoice-app--button button-savechanges"
              style={{ marginLeft: "8px" }}
              type="button"
              onClick={submitForm}
            >
